...
Cột mốc dịch chuyển (Segment-Shift nối về Step 0)	M01 (12/2022): Ra mắt Perplexity Answer Engine — Chuyển từ Retrieve (Google) sang Answer with Citation.	M03 (04/2024): Enterprise Pro & File Upload.
M04 (05/2024): Perplexity Pages (biến nghiên cứu thành báo cáo có thể chia sẻ).
M06 (02/2025): Deep Research (ủy quyền workflow nghiên cứu đa bước).
M08 (07/2025): Comet Browser & M10 (02/2026): Perplexity Computer (chuyển hẳn sang Agentic Execution).
...
💡 Trả lời chi tiết:
Lực giữ chân mạnh nhất hiện tại:
...
Nếu lực đó biến mất (hoặc bị đối thủ triệt hạ) thì chuyện gì xảy ra?
